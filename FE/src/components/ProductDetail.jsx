...
//   const { productItem, formatNumber } = useContext(Context);
//   return (
//     <div>
...
//             <div
//               className="img-detail d-flex flex-column"
//               style={{ margin: "20px" }}
//             >
//               <img
//                 src={item.img[0]}
...
//                   src={item.img[1]}
//                   alt={item.name}
//                   className="img-detail-2"
//                   style={{ width: "200px", height: "200px", margin: "10px" }}
//                 />
//                 <img
//                   src={item.img[2]}
//                   alt={item.name}
//                   className="img-detail-3"
//                   style={{ width: "200px", height: "200px", margin: "10px" }}
//                 />
//               </div>
//             </div>
...
//               <div className="d-flex">
//                 <div
//                   className="countChange d-flex"
//                   style={{ marginLeft: "20px", width: "150px" }}
//                 >
//                   <button className="decrease" style={{ width: "40px" }}>
//                     -
//                   </button>
//                   <div
//                     className="increase d-flex justify-content-center"
...
//                 <div className="cocoment">
//                   BE THE FIRST TO REVIEW {`"${item.name.toLocaleUpperCase()}".`}
//                 </div>
